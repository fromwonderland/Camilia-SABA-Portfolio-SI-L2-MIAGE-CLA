...
const appData = {
    ...
    '📂Projet final': ['AURA.zip','AURA PROJET SI Document partagé.pdf', 'AURA SI Documentation technique.pdf', 'AURA Diagramme UML.png', 'Maquette AURA logo.jpg','Maquette Accueil.png', 'Maquette Connexion.png', 'Maquette Création compte.png', 'Maquette Contacts.png','Maquette Color palette.png'],
